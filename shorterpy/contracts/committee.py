...
class Committee(BaseContract):
    ...
    def create_pool_proposal(self, staked_token: str, leverage: int, duration_days: int, gas_params: GasParams) -> Any:
        '''
    ...
    def vote(self, proposal_id: int, direction: bool, vote_share: int, gas_params: GasParams) -> Any:
        '''
